...
worm.execute = function ($instance, q, cb) {
  // @TODO:
  ...
  $instance.model.adapters.forEach(function (adapter) {
    ...
    var values = $instance.sliceDirtyAttributes();
    adapter.execute(q, $instance.model, values, function (err, res) {
      // @TODO: not sure :D
      debug(res);
      cb(err, res);
    });
...
worm.queryCallback = function (method, something) {
  ...
  callbacks = {
    ...
    getAll: function (q, cb) {
      ...
      worm.execute($instance, q, function (err, res) {
        var $instance;
    ...
    save: function (q, cb) {
      ...
      worm.execute($instance, q, function (err, obj) {
